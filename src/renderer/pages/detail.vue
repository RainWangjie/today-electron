        ...
        <div class="content">
          ...
          <div class="content-body">
            <div class="picker-container">
              <date-picker ref="duePicker" icon="fa-calendar" :placeholder="$t('detailView.pickADueDate')" :classes="dueClasses" :value="dueDate" @date-changed="handleDueDateChanged" />
            </div>
            <div class="picker-container">
              <date-picker ref="planPicker" :placeholder="$t('detailView.pickAPlanDate')" :classes="planClasses" :value="planDate" @date-changed="handlePlanDateChanged" />
            </div>
            <div class="desc-container">
              <input-box :placeholder="$t('detailView.description')" type="textarea" :value="detailedTodoItem.desc" @input="handleDescInput" />
            </div>
          </div>
        </div>
      </div>
