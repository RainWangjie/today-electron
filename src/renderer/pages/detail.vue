          ...
          <div class="content-body">
            <div class="picker-container">
              <date-picker
                ...
                :classes="dueClasses"
                :value="dueDate"
                @date-changed="handleDueDateChanged" />
            </div>
            <div class="picker-container">
              <date-picker
                ref="planPicker"
                ...
                :classes="planClasses"
                :value="planDate"
                @date-changed="handlePlanDateChanged" />
            </div>
...
import DatePicker from '../components/wzel/components/date-picker/index'
